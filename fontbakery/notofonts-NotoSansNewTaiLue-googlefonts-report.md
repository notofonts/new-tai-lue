 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, syriac, tifinagh, tai-le, malayalam, coptic, math, old-permic
 ...
 * U+3000 IDEOGRAPHIC SPACE: try adding one of: yi, chinese-simplified, japanese, nushu, chinese-hongkong, chinese-traditional
 * U+3001 IDEOGRAPHIC COMMA: try adding one of: yi, chinese-simplified, japanese, tai-le, phags-pa, mongolian, chinese-hongkong, chinese-traditional
 * U+3002 IDEOGRAPHIC FULL STOP: try adding one of: yi, chinese-simplified, japanese, nushu, tai-le, phags-pa, mongolian, chinese-hongkong, chinese-traditional
 * U+3008 LEFT ANGLE BRACKET: try adding one of: yi, chinese-simplified, japanese, tai-le, phags-pa, chinese-hongkong, chinese-traditional
 * U+3009 RIGHT ANGLE BRACKET: try adding one of: yi, chinese-simplified, japanese, tai-le, phags-pa, chinese-hongkong, chinese-traditional
 * U+300A LEFT DOUBLE ANGLE BRACKET: try adding one of: lisu, yi, chinese-simplified, japanese, tai-le, phags-pa, mongolian, chinese-hongkong, chinese-traditional
 * U+300B RIGHT DOUBLE ANGLE BRACKET: try adding one of: lisu, yi, chinese-simplified, japanese, tai-le, phags-pa, mongolian, chinese-hongkong, chinese-traditional
 ...
 * U+FF0E FULLWIDTH FULL STOP: try adding one of: chinese-simplified, japanese, yi
 * U+FF1A FULLWIDTH COLON: try adding one of: chinese-simplified, japanese, yi
...
Or you can add the above codepoints to one of the subsets supported by the font: `latin`, `latin-ext`, `new-tai-lue` [code: unreachable-subsetting]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Nateni (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Mango (Latn, 77,000 speakers), Navajo (Latn, 166,319 speakers), Aghem (Latn, 38,843 speakers), Avokaya (Latn, 100,000 speakers), Sar (Latn, 500,000 speakers), Dan (Latn, 1,099,244 speakers), Basaa (Latn, 332,940 speakers), Koonzime (Latn, 40,000 speakers), Ma’di (Latn, 584,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Kom (Latn, 360,685 speakers), Gulay (Latn, 250,478 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ejagham (Latn, 120,000 speakers). [code: soft-dotted]
